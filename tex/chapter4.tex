...
\begin{figure}[t]
  \centering
    \subfloat[Advection of passive scalar and convective boundary growth]{\includegraphics[width=0.4\textwidth]{./img/2d001-LRmach}\label{fig:2d001-LRmach}}
      \hfill
        \subfloat[Profile of the mach number over time]{\includegraphics[width=0.4\textwidth]{./img/2d001-LRps2}\label{fig:2d001-LRps2}}
	  \label{2d001-LRps2}
  \end{figure}
