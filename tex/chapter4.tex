...
\begin{figure}[t]
  \centering
    \subfloat[Advection of passive scalar and convective boundary growth]{\includegraphics[width=0.5\textwidth]{./img/tempprofile}\label{fig:2d0.7-0.01LR.bp}}
      \hfill
        \subfloat[Profile of the mach number over time]{\includegraphics[width=0.5\textwidth]{./img/tempprofile}\label{fig:2d0.7-0.01LR.turbmach}}
      \hfill
        \subfloat[Profile of the mach number over time]{\includegraphics[width=0.5\textwidth]{./img/tempprofile}\label{fig:2d0.7-0.01LR.delb}}
      \hfill
        \subfloat[Profile of the mach number over time]{\includegraphics[width=0.5\textwidth]{./img/tempprofile}\label{fig:2d0.7-0.01LR.l}}
