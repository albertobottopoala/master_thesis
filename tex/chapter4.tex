...
\begin{figure}[t]
  ...
  \end{figure}
Let's consider the setup 2d0.1-1.00. \\
...
We show first of all the boundary position over time with its rms. The migration starts quiclky, but as soon as the bounrady rms stabilizes at $t=20000 s$ after three convective turnovers, it becomes overall linear. \\
