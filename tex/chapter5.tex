...
\hfill
\subfloat[The same passive scalar of above, advected at $t \simeq 800 \ \mathrm{min}$. This defines the topology of the boundary. In the magnification a region of fully convective fluid with density of passive scalar close to unity (see text).]{\includegraphics[width=12cm]{./img/passive2acc2mag.pdf}\label{fig:passiveacc2}}
...
For the runs with lower resolution this method worked perfectly, but when moving to a higher resolution a problem appeared. As the magnification in Figure (\ref{fig:passiveacc2}) and (\ref{fig:topology}) show, in the middle of the convective layer some blobs of entrained material are visible, that even when fully in a convective regime still contain a very high passive scalar density. This is due to the fact that the higher the resolution, the lower the numerical diffusion.
...
\caption{The detected boundary topology over the passive scalar density. In the magnification a corrupted value for the boundary position (see text).}
\label{fig:twin}
\centering
\end{figure}
...
\begin{figure}[t!]
      \centering
        \subfloat[Mach number profile over time.]{\includegraphics[width=10cm]{./img/mach.pdf}\label{fig:3dmachprofile}}
     \centering
	\hfill
        \subfloat[Entrainment of passive scalar from the upper stable region into the convective region.]{\includegraphics[width=10cm]{./img/ps2.pdf}\label{fig:3dpsprofile}}
