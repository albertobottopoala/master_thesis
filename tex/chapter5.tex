...
\caption{The detected upper boundary topology over the passive scalar density. In the magnification a corrupted value for the boundary position (see text).}
\label{fig:topology}
\centering
\end{figure}
